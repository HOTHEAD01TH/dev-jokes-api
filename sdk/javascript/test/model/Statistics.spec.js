...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DevJokesApi.Statistics();
  });
  ...
  describe('Statistics', function() {
    it('should create an instance of Statistics', function() {
      ...
      //var instance = new DevJokesApi.Statistics();
      //expect(instance).to.be.a(DevJokesApi.Statistics);
    });
    ...
    it('should have the property lastDowntime (base name: "lastDowntime")', function() {
      // uncomment below and update the code to test the property lastDowntime
      //var instance = new DevJokesApi.Statistics();
      //expect(instance).to.be();
    });
